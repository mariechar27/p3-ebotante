      ...
      <div className="w-full max-w-2xl flex flex-col sm:flex-row sm:flex-wrap md:flex-nowrap justify-between space-y-4 sm:space-y-0 sm:space-x-4 text-center">
        {[
          ...
          },
          {
            ...
            hoverBg: "hover:bg-blue-200",
            border: "border-blue-400",
            img: "https://ash.harvard.edu/wp-content/uploads/2024/10/updated-email-design-270-x-180-25.png",
          },
          {
            title: "Access",
            ...
            hoverBg: "hover:bg-blue-200",
            border: "border-blue-400",
            img: "https://www.momscleanairforce.org/wp-content/uploads/2018/11/vote_phone.jpg",
          },
